...
class Enclosure():
    '''
    Create a Delft3D-FLOW enclosure file
    Enclosure excludes grid-cells from computation
    ...
    def read(filename=None):
        ...
        with open(filename, 'r') as enc_file:
            ...
            # how would i know from read file has channel? by nr of lines (more than 5)?
